/**
 * Compact, dependency-free SHA-256 + HMAC-SHA256 over byte arrays.
 *
 * Used to compute the pairing proof so we don't pull in a native crypto module just to pair.
...
export function sha256(msg: Uint8Array): Uint8Array {
  ...
  // 64-bit big-endian length in the last 8 bytes (high word assumed 0 for our message sizes)
